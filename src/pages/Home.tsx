...
const Home = () =>{
  ...
  {/* White overlay above the image, below everything else */}
  <div className="absolute inset-0 bg-black/50 z-10" />

  {/* Pattern on top of white overlay */}
  ...
  <div className="content-wrapper relative z-30 w-full">
    ...
    <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-medium mb-6 text-white animate-fade-in">
